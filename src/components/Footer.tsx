        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="/shop" className="text-text-secondary hover:text-primary transition">
                  Shop
                </a>
              </li>
              <li>
                <a href="/breaks" className="text-text-secondary hover:text-primary transition">
                  Breaks
                </a>
              </li>
              <li>
                <a href="/cart" className="text-text-secondary hover:text-primary transition">
                  Cart
                </a>
              </li>
              <li>
                <a href="/account" className="text-text-secondary hover:text-primary transition">
                  Account
                </a>
              </li>
            </ul>
          ...
          {/* Social Links */}
          <div>
            <h4 className="text-text-primary font-semibold mb-3">Follow Us</h4>
