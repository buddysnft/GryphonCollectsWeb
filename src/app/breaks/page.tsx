  ...
  return (
    <div className="min-h-screen py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-primary mb-2">Upcoming Breaks</h1>
          <p className="text-text-secondary">
            {breaks.length} {breaks.length === 1 ? "break" : "breaks"} scheduled
          </p>
        </div>

        {/* Live Links */}
        <div className="bg-surface border border-border rounded-lg p-6 mb-8">
          <h2 className="text-xl font-bold text-text-primary mb-4">Watch Live</h2>
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href="https://youtube.com/@gryphoncollects"
              target="_blank"
            ...
            <a
              href="https://instagram.com/gryphoncollects"
              target="_blank"
              rel="noopener noreferrer"
        ...
        {breaks.length > 0 ? (
          ...
          <div className="text-center py-16">
            <p className="text-text-secondary text-lg">No breaks scheduled</p>
            <p className="text-text-muted text-sm mt-2">
              Check back soon for upcoming breaks
            </p>
          </div>
        )}
      </div>
